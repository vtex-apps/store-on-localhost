...
const orderFormQuery = loader('../StoreResources/queries/orderForm.gql')
const addToCart = loader('../StoreResources/mutations/addToCart.gql')
const updateItems = loader('../StoreResources/mutations/updateItems.gql')
const fullMinicartQuery = loader('./legacy/localState/graphql/fullMinicartQuery.gql')
const updateItemsMutation = loader('./legacy/localState/graphql/updateItemsMutation.gql')
const updateOrderFormMutation = loader('./legacy/localState/graphql/updateOrderFormMutation.gql')
const updateLocalItemStatusMutation = loader('./legacy/localState/graphql/updateLocalItemStatusMutation.gql')
const setMinicartOpenMutation = loader('./legacy/localState/graphql/setMinicartOpenMutation.gql')
