...
const updateOrderFormShipping = loader('../../../StoreResources/mutations/updateOrderFormShipping.gql')
const updateOrderFormCheckin = loader('../../../StoreResources/mutations/updateOrderFormCheckin.gql')
const fullMinicartQuery = loader('./graphql/fullMinicartQuery.gql')
