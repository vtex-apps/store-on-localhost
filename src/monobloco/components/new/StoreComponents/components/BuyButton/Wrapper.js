...
const addToCartMutation = loader('./mutations/addToCart.gql')
const setOpenMinicartMutation = loader('./mutations/setOpenMinicart.gql')
const installedApp = loader('./queries/installedApp.gql')
