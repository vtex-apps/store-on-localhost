...
export const getDirectChildren = (extensions: any, treePath: string) => {
  return Object.entries(extensions)
    .filter(
      ([id, extension]: any) => extension.component && isDirectChild(id, treePath)
    )
...
export function withTreePath<TOriginalProps>(
  ...
  return hoistNonReactStatics<any, any>(
    WithTreePath,
    Component
  )
}
